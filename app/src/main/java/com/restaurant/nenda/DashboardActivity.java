...
import com.restaurant.nenda.adapter.RestaurantAdapter;
import com.restaurant.nenda.data.Session;
import com.restaurant.nenda.model.ListRestaurantResponse;
    ...
    private void initSearch(){
        svRestaurant.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                loadItem(Constans.GET_SEARCH_RESTAURANT + query);
                return true;
            }
            @Override
            public boolean onQueryTextChange(String newText) {
                ...
                loadItem(Constans.GET_SEARCH_RESTAURANT + newText);
                return true;
            }
        });
        svRestaurant.setOnCloseListener(new SearchView.OnCloseListener() {
            ...
            public boolean onClose() {
                loadItem(Constans.GET_LIST_RESTAURANT);
                return false;
            }
        });
    }
